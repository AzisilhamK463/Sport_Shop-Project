        ...
        <div class="container-fluid">
            <header>
                    ...
                    <ul>
                        ...
                        <li><a href="dex.php"><span class="material-symbols-rounded">inventory_2</span></a></li>
                        <li><a href="crud.php"><span class="material-symbols-rounded">inventory</span></a></li>
                        <li><a href="#"><span class="material-symbols-rounded active">draft_orders</span></a></li>
            ...
            <div id="box">
                ...
                <tr>
                    ...
                    <td><a href="proses_transaksi.php?id=<?php echo $user_data['id'] ?>">
                        <span class="material-symbols-rounded active">edit</span></a></td>
                </tr>  
                    <?php      
                }
                ?>
